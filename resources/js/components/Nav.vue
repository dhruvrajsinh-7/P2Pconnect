<template>
    ...
    >
            ...
            <div class="flex">
                ...
                <div class="ml-2">
                    <div class="ml-2 relative">
                        <div class="absolute text-gray-700 hover:text-red-600">
        ...
        <div class="w-1/3 h-full flex justify-center items-center">
            <router-link
                to="/"
                class="px-6 h-full flex border-b-2 border-blue-600 items-center"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
            ...
            <router-link
                to="/"
                class="h-full px-6 flex order-b-2 border-white items-center"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
